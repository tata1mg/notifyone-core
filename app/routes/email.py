...
email_blueprint = Blueprint("EmailAPIs")

@email_blueprint.route("/email/template", methods=["PUT"], name="update_email_template")
...
@email_blueprint.route("/email/preview", methods=["POST"], name="preview_email_subtemplate")
